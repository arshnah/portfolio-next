export const projects = [
  ...
  { year: "2023", name: "JustCallTech", url: "https://justcalltech.in",
    desc: "An IT-services brand. I built the Android app (live on the Play Store) and the website: bookings for laptop repair, wifi, CCTV. Pushed the site to 97/100 on Google's SEO score." },
